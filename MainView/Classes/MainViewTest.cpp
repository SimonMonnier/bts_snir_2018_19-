...
CPPUNIT_TEST_SUITE_REGISTRATION(MainViewTest);
...
int main(int argc, char* argv[])
{
    ...
    // for hudson
    std::ofstream file( "MainView-cppunit-report.xml" );
